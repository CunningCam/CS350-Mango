    ...
    public void execute() {
        ...
        for (ReportPointVO reportPoint : reportConfig.getPoints()) {
            ...
            if (point != null && Permissions.hasDataPointReadPermission(user, point)) {
                ...
                points.add(new ReportDao.PointInfo(point, colour, reportPoint.isConsolidatedChart(), reportPoint.isScatter(),
                    reportPoint.getTitle(), reportPoint.getXlabel(), reportPoint.getYlabel(), reportPoint.getYref()));
            }
        }
